...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.DB_Line_Host.setPlaceholderText(_translate("MainWindow", "数据库的IP地址localhost"))
        self.DB_Lab_Port.setText(_translate("MainWindow", "数据库端口号"))
        self.DB_Line_Port.setPlaceholderText(_translate("MainWindow", "数据库的端口号3306"))
        self.DB_Lab_Userid.setText(_translate("MainWindow", "用户名"))
        self.DB_Line_Userid.setPlaceholderText(_translate("MainWindow", "数据库的用户名root"))
        self.DB_Lab_Password.setText(_translate("MainWindow", "密码"))
        self.DB_Line_Password.setPlaceholderText(_translate("MainWindow", "数据库的密码123456"))
